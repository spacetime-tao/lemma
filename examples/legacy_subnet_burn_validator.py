...
# ruff: noqa
"""
LEGACY DEMO ONLY — NOT THE LEMMA SUBNET VALIDATOR.

This script sets 100% weights on UID 0 every tempo (classic subnet template "burn").
**Do not run for Lemma.** Real scoring: ``lemma validator`` / ``lemma validator start``
(see ``docs/validator.md``).

Kept for educational comparison with generic Bittensor subnet tutorials.
"""
