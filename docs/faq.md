...
One-line mental model: Lemma incentivizes Lean-valid theorem proving; today, passing submissions are also ranked by judged reasoning quality under the same pinned validator policy.
