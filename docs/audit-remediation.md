...
| `tests/` | 2 330 | 3 894 (59 files) | +1 564 |
| `docs/` markdown | 1 355 | 2 829 (30 files) | +1 474 |
...
| 2026-05 | Tightened proof-metrics readiness around same-theorem comparisons |
