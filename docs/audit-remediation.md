...
| ID | Issue | Source § | Priority | Remediation direction |
|----|--------|----------|----------|------------------------|
| **R1** | 28 templates enumerable; SHA256 mix is **public** — offline cache still works | R3 §9, §9.1 | P2 | **Needs-design/partial:** public deterministic supply boundary documented; mitigation is builder breadth, release rotation, and future curated lanes, not seed secrecy. | `docs/problem-supply-policy.md`, `docs/generated-problems.md` |
