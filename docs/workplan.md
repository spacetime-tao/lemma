...
1. Replace or reduce `proof_intrinsic_score`; length is a weak proxy for mathematical value. **Decision note added:** [proof-intrinsic-decision.md](proof-intrinsic-decision.md). Next behavior change should lower the default weight or prototype a Lean-backed replacement, not add more regex padding checks.
