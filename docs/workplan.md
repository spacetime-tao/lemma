...
The 2026-05-17 miner replacement moved the six-miner layout to a new host.

| Host role | Deployed state | Running Lemma services |
| --- | --- | --- |
| validator / Lean worker | `d32119e` checkout; validator active | `lemma-validator.service`, `lemma-public-dashboard.timer` |
| miner | `a89c41a` | `lemma-miner.service`, `lemma-miner3.service`, `lemma-miner4.service`, `lemma-miner5.service`, `lemma-miner6.service`, `lemma-miner7.service` |
