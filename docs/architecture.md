...
| [`lemma/judge/`](../lemma/judge/) | Optional prose-evaluation tooling while proof-only scoring is implemented. |
| [`lemma/scoring/`](../lemma/scoring/) | Proof-side scoring + Pareto → weights. |
