"""Shared CLI formatting for theorem identity (topic, split, Lean goal)."""
    ...
    if show_timeout_help and settings is not None and synapse_timeout_s is not None:
        ...
        click.echo(
            stylize(
                ...
                f"(blocks×block time; see LEMMA_FORWARD_WAIT_*). "
...
def echo_next_theorem_countdown(
    ...
    *,
    ...
    """Print blocks / estimated wall-clock until the shared theorem may change (same as ``lemma status``)."""
    import click
